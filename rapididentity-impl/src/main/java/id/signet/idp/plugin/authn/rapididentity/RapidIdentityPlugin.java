...
/**
 * Details about the RapidIdentity MFA plugin.
 */
public class RapidIdentityPlugin extends PropertyDrivenIdPPlugin {
     ...
     */
    public RapidIdentityPlugin() throws IOException, PluginException {
        super(RapidIdentityPlugin.class);
        try {
            final IdPModule module = new RapidIdentityModule();
